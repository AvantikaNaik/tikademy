...
def match():
    if request.method == "POST":
        ...
        schedule_info = db.execute("SELECT match.id FROM schedule match JOIN schedule main WHERE main.id=:main_id AND main.id != match.id AND match.role=:match_role AND (main.v_8M=match.v_8M OR main.v_8T=match.v_8T OR main.v_8W=match.v_8W OR main.v_8R=match.v_8R OR main.v_8F=match.v_8F OR main.v_8S=match.v_8S OR main.v_8U=match.v_8U OR        main.v_10M=match.v_10M OR main.v_10T=match.v_10T OR main.v_10W=match.v_10W OR main.v_10R=match.v_10R OR main.v_10F=match.v_10F OR main.v_10S=match.v_10S OR main.v_10U=match.v_10U OR         main.v_12M=match.v_12M OR main.v_12T=match.v_12T OR main.v_12W=match.v_12W OR main.v_12R=match.v_12R OR main.v_12F=match.v_12F OR main.v_12S=match.v_12S OR main.v_12U=match.v_12U OR     main.v_2M=match.v_2M OR main.v_2T=match.v_2T OR main.v_2W=match.v_2W OR main.v_2R=match.v_2R OR main.v_2F=match.v_2F OR main.v_2S=match.v_2S OR main.v_2U=match.v_2U OR    main.v_4M=match.v_4M OR main.v_4T=match.v_4T OR main.v_4W=match.v_4W OR main.v_4R=match.v_4R OR main.v_4F=match.v_4F OR main.v_4S=match.v_4S OR main.v_4U=match.v_4U OR     main.v_6M=match.v_6M OR main.v_6T=match.v_6T OR main.v_6W=match.v_6W OR main.v_6R=match.v_6R OR main.v_6F=match.v_6F OR main.v_6S=match.v_6S OR main.v_6U=match.v_6U OR main.v_8NM=match.v_8NM OR main.v_8NT=match.v_8NT OR main.v_8NW=match.v_8NW OR main.v_8NR=match.v_8NR OR main.v_8NF=match.v_8NF OR main.v_8NS=match.v_8NS OR main.v_8NU=match.v_8NU)", main_id=session["user_id"], match_role=match_role )

        schedule_match_usernames = []

        for match in schedule_info:
            subject_id = match["id"]
            schedule_match_usernames.append(subject_id)

        overlap = list(set(grade_match_usernames) & set(schedule_match_usernames) & set(subject_match_usernames))
